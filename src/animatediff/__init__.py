...
HF_HOME = Path(getenv("HF_HOME", None) or Path.home().joinpath(".cache", "huggingface")).resolve()
HF_HUB_CACHE = Path(getenv("HUGGINGFACE_HUB_CACHE", None) or HF_HOME.joinpath("hub")).resolve()
